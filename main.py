...
from classes_simulation import PMEmulation, EmulatedMotor
...
with ui.column().classes('w-full items-center gap-6 mt-4'):
    ...
    with ui.row().classes('w-full md:w-2/3 gap-6').style('flex-wrap: wrap'):
        ...
        with ui.card().classes(
            ...
            status_label = ui.label("⚠️ Non connecté").classes('text-sm mb-2')
        ...
        with ui.card().classes(
            ...
            motor_status_label = ui.label("⚠️ Non connecté").classes('text-sm mb-2')
